...
async function extractPreview(file, bytes) {
    ...
    const textLike = TEXT_MIME_TYPES.has(file.type) || [
        ".md",
        ".txt",
        ".csv",
        ".json",
...
async function POST(request) {
    ...
    const id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ids$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createId"])("file");
    const safeName = file.name.replace(/[^\w.\- ]+/g, "_");
    const storedName = `${id}-${safeName}`;
    const storagePath = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUploadsDir"])(), storedName);
    await __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["promises"].mkdir((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUploadsDir"])(), {
        recursive: true
    });
    await __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["promises"].writeFile(storagePath, bytes);
    const now = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ids$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["nowIso"])();
    const stored = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateData"])((data)=>{
        const item = {
            id,
            projectId,
            sessionId,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addFileToData"])(data, item);
        return item;
    });
    const preview = await extractPreview(file, bytes);
    const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateData"])((data)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02zdgnv._.js.map